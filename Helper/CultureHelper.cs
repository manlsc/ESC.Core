...
namespace ESC.Core
{
    public static class CultureHelper
    {
        ...
        {
            if (name.Equals("zh-cn", StringComparison.CurrentCultureIgnoreCase)||
                name.Equals("zh-tw", StringComparison.CurrentCultureIgnoreCase)||
                name.Equals("sv-se", StringComparison.CurrentCultureIgnoreCase) ||
                name.Equals("pt-br", StringComparison.CurrentCultureIgnoreCase))
            {
                return name;
            }
