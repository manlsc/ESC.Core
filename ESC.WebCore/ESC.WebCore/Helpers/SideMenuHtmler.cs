...
namespace ESC.WebCore.Helpers
{
    public static class SideMenuHtmler
    {
        /// <summary>
        /// 左侧菜单
        /// </summary>
        ...
        public static string SideMenu(this HtmlHelper helper, int userId, int superUser, string url)
        {
