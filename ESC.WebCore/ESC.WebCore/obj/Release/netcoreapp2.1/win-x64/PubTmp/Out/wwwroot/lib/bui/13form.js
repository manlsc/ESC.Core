...
(function (BUI, $) {
    ...
    var selectField = Field.extend({
        renderUI: function () {
            ...
            var itemArr = _self.setItems(items);
            var tpl = '';
            for (var i = 0; i < itemArr.length; i++) {
                tpl += '<option value="' + itemArr[i].value + '">' + itemArr[i].text + '</option>';
            }
            _self.getInnerControl().html(tpl);
        },
    ...
    },
        {
            ATTRS: {
                items: {},
                controlTpl: {
                    value: '<select class="form-control"></select>'
                },
                showBlank: {
                    value: true
                },
...
(function (BUI, $) {
    ...
    var selectField = Field.extend({
        ...
        {
            xclass: "form-field-select2"
        });
    BUI.Form.Field.Select2 = selectField;
})(window.BUI, jQuery);
