#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\BLocation\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c2d238494ba481575ea5f7bf10285e9fd1664609"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c2d238494ba481575ea5f7bf10285e9fd1664609", @"/Views/BLocation/Index.cshtml")]
...
");
   ...
   ");
        ...
        function initUserColumns(iData) {
            for (var i = 0; i < iData.Columns.length; i++) {
                switch (iData.Columns[i].dataIndex) {
                    ...
                    case ""OrgID"":
           ");
                WriteLiteral(@"             iData.Columns[i].visible = true;
                        break;
                    default:
        ...
        //选择用户
        common.se");
                WriteLiteral(@"archUser = function () {
            var deleteRow = tree.getSelected();
            if (deleteRow == null) {
                CommonBUI.alert(""提示"", ""请选择存储单元."");
                return false;
            ...
            var dialog = new BUI.Overlay.Dialog({
                ...
                success: function () {
                    ...
                    common.pos");
                WriteLiteral(@"t(common.controller, ""AddUser"", addItems, function () {
        ...
        common.removeUser = function () {
            ...
            common.post(common.controller, ""RmoveUser"", deleteItems, function () {
                Com");
                WriteLiteral(@"monBUI.alert(""提示"", ""删除成功."");
                loadGrid(deleteRow.id);
            });
        }
