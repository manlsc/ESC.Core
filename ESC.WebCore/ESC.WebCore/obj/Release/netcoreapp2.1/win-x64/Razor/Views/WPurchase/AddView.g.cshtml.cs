#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WPurchase\AddView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6b9a6462e691a7e56a95776e991192034afa0543"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6b9a6462e691a7e56a95776e991192034afa0543", @"/Views/WPurchase/AddView.cshtml")]
   ...
   ");
    ...
    function searchBp(frm, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            mask: true,
            closeAction: ""destroy"",
            bodyContent: '<iframe id=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../B");
            WriteLiteral(@"BusinessPartner/SearchBusinessPartnerView"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
    ...
    function searchStock(bGrid, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                var data = CommonBUI.Excu");
            WriteLiteral(@"teIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
                    bGrid.setReturnValue(opts, data);
                    dialog.close();
                } else {
        ...
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                ...
                if (data) {
                    ...
                    Co");
            WriteLiteral(@"mmonBUI.alert(""提示"", ""选择存储单元."");
                }
            }
        });
        dialog.show();
