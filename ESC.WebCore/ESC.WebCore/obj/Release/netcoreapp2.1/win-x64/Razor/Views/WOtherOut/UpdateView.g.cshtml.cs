#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WOtherOut\UpdateView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e269701daab0e5716d932e5fe3d056c7ec833eb3"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e269701daab0e5716d932e5fe3d056c7ec833eb3", @"/Views/WOtherOut/UpdateView.cshtml")]
...
#line hidden
    ...
    function searchStock(bGrid, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            mask: true,
            closeAction: ""destroy"",
            bodyContent: '<iframe id=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../W");
                WriteLiteral(@"Stock/SearchStockView"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
    ...
    $(document).ready(function () {
        ...
        //外键初始化
        fcommon.ForeignInit(""WOtherOut");
                WriteLiteral(@"Line"", function (fData) {
