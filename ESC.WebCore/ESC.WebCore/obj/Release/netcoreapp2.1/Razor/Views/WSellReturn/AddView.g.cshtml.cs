#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WSellReturn\AddView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e2974dbbf6779d36608169dee2265266cd5ce97c"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e2974dbbf6779d36608169dee2265266cd5ce97c", @"/Views/WSellReturn/AddView.cshtml")]
...
<script type=""text/javascript"">
    ...
    function searchBp(frm, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            WriteLiteral(@"../BBusinessPartner/SearchBusinessPartnerView"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
    ...
    function searchStock(bGrid, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                var data = CommonBUI.");
            WriteLiteral(@"ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
                    bGrid.setReturnValue(opts, data);
                    dialog.close();
                } else {
        ...
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                ...
                if (data) {
                  ...
                  ");
            WriteLiteral(@"  CommonBUI.alert(""提示"", ""选择存储单元."");
                }
            }
        });
        dialog.show();
