#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WSell\UpdateView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3bf7ca4a481dc80599855ac2e59b9918a09790b0"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3bf7ca4a481dc80599855ac2e59b9918a09790b0", @"/Views/WSell/UpdateView.cshtml")]
...
#line hidden
    ...
    function searchLocation(frm, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            mask: true,
            closeAction: ""destroy"",
            bodyContent: '<iframe id");
                WriteLiteral(@"=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../BLocation/SearchLocationWhView"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
                    frm.setReturnValue(opts, data);
    ...
    function searchNoticeLine(bGrid, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            mask: true,
            closeAction: ""destroy"",
            bodyContent: '<iframe id=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../WStock/SearchStockSellNoticeView?ParentID=' + bForm.data.SourceID + '&WarehouseID=' + bForm.data.WarehouseID+'"" style=""width:100%;height:100%;""></iframe");
                WriteLiteral(@">',
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
    ...
    $(document).ready(function () {
        ...
        fcommon.ForeignInit(""WSellLine"", function (fData) {
           ...
           ");
                WriteLiteral(@" initColumns(fData);
            initGrid(fData);
        });
