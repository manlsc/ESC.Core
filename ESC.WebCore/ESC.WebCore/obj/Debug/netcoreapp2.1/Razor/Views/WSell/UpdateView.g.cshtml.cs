#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WSell\UpdateView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "89466a0d4a8877a0f057f805289a6090e9ab3c31"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"89466a0d4a8877a0f057f805289a6090e9ab3c31", @"/Views/WSell/UpdateView.cshtml")]
...
#line hidden
        ...
        bGrid.fSearch = function (opts) {
            ...
            if(record.SourceLineID>0){  //如果下推的行更新，只能选择货位
                searchLoc(bGrid, opts);
            } else {
                if (!BUI.isNullOrEmpty(bForm.data.SourceCode)) {  //如果下推单，添加行，查询通知单
                    searchNoticeLine(bGrid, opts);
                } else {
                    searchStock(bGrid, opts);  //查询库存
                }
            }
        };
        bGrid.init();
    ...
    function searchLocation(frm, opts) {
        var dia");
                WriteLiteral(@"log = new BUI.Overlay.Dialog({
            title: ""选择存储单元"",
            width: 800,
            height: 600,
            mask: true,
    ...
    function searchNoticeLine(bGrid, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            closeAction: ""destroy"",
            bodyContent: '<iframe");
                WriteLiteral(@" id=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../WStock/SearchStockSellNoticeView?NoticeID=' + bForm.data.SourceID + '&WarehouseID=' + bForm.data.WarehouseID+'"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
...
");
    ...
    function searchLoc(bGrid, opts) {
        ...
        var dialog = new B");
                WriteLiteral(@"UI.Overlay.Dialog({
            title: ""选择存储单元"",
            width: 800,
            height: 600,
            mask: true,
         ...
         ");
                WriteLiteral(@"           bGrid.setReturnValue(optss, data);
                    dialog.close();
                } else {
