#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WPurchaseReturn\AddView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9a5acc7a36bcd8063f3979a4cedb2197c19464ae"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9a5acc7a36bcd8063f3979a4cedb2197c19464ae", @"/Views/WPurchaseReturn/AddView.cshtml")]
...
");
        ...
        function searchStock(bGrid, opts) {
            ...
            var dialog = new BUI.Overlay.Dialog({
                ...
                success: function () {
                    var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                    if (data) {
                        bGrid.setReturnValue(");
                WriteLiteral(@"opts, data);
                        dialog.close();
                    } else {
  ...
  ");
                WriteLiteral(@"                          CommonBUI.alert(""提示"", ""订单明细不能为空"")
                        }
                    }
                }
            });
