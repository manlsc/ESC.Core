#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WPurchaseReturn\UpdateView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "98ac0e5d8697794712bca8a26edd2e763e5ee073"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"98ac0e5d8697794712bca8a26edd2e763e5ee073", @"/Views/WPurchaseReturn/UpdateView.cshtml")]
   ...
   ");
    ...
    //选择通知单行
        ...
        var dialog = new BUI.Overlay.Dialog({
            ...
            mask: true,
            closeAction: ""destroy"",
            bodyContent: '<iframe id=""ifrmSearch"" scrolling=""auto"" frameborder=""0""  src=""../WStock/SearchStockPurchaseView?Warehous");
                WriteLiteral(@"eID=' + bForm.data.WarehouseID+'&ParentID=' + bForm.data.SourceID + '"" style=""width:100%;height:100%;""></iframe>',
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearch"", ""getData"");
                if (data) {
