#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WPurchase\UpdateView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e8275d583fabd0c0ccf668df2fee7661d4f1f5d7"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e8275d583fabd0c0ccf668df2fee7661d4f1f5d7", @"/Views/WPurchase/UpdateView.cshtml")]
...
#line hidden
            ...
            if (BUI.isNullOrEmpty(opts.text) || opts.evttype == ""click"") {
                ...
                if (opts.param.table == ""BLocation"") {
                    ...
                    fcommon.get(""BLocation"", ""GetLocationCodeNameNotWh"", ""words="" + CommonBUI.UrlEncode(opts.text), function (rdata) {
                        if (");
            WriteLiteral(@"rdata.result.length == 1) {
                            var data = rdata.result[0];
    ...
    function searchBp(frm, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmSearc");
            WriteLiteral(@"h"", ""getData"");
                if (data) {
    ...
    function searchDetail(pageIndex, pageSize){
        common.SelectDetail(""WTransferhOutLine"",id, pageIndex, pageSize, functi");
