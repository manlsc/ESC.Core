#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WInventory\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "acca3cf3ead070209e15822ad90a2172aeb8c8c2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"acca3cf3ead070209e15822ad90a2172aeb8c8c2", @"/Views/WInventory/Index.cshtml")]
...
<div id=""InventoryForm"">
    <ul class=""bui-search-ul"">
        ...
        <li class=""bui-inline-block"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e0c7bacdb9a54a48af55db51960aaf2f", async() => {
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e35e4b00cfe34f9da4bd80b01699275b", async() => {
...
<script type=""text/javascript"">
        ...
        bGrid.onInit = function (dftGrid) {
            for (var i = 0; i < dftGrid.columns.length; i++) {
                ...
                if (col.dataIndex == ""InventoryCode"") {
                    ...
                    col.renderer =");
            WriteLiteral(@" function (value, record, index) {
                        if (value) {
    ...
    common.profit = function () {
        ...
        common.post(common.controller, ""AddProfit"", data, function (rdata) {
            ...
            WriteLiteral(@" ""../WOtherIn/UpdateView?ID="" + rdata.result;
            } else {
                CommonBUI.alert(""提示"", rdata.message);
            }
        });
