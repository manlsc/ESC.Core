#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\BMaterialGroup\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "bed753ec6e11042422c509e4967e7afd4ced38a8"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"bed753ec6e11042422c509e4967e7afd4ced38a8", @"/Views/BMaterialGroup/Index.cshtml")]
...
<script type=""text/javascript"">
    ...
    v");
            WriteLiteral(@"ar fcommon = new CommonBUI({ controller: ""BMaterialGroup"", DataGrid: ""#LocationGrid"", Btns: ""#BMaterialGroupBtns"" });
    ...
    common.add = function () {
        ...
        if (grpData) {
         ...
         ");
            WriteLiteral(@"   data.ParentName = grpData.GroupName;
        }
            ...
            if (opts.param.table == ""Organization"") {
                ...
                common.get(""SOrganization"", ""GetOrganizationCodeName"", ""words="" + CommonBUI.UrlEncode(opts.text), function (rdata) {
                    if (rdata.result.length == 1) {
                        ...
                        //查询物料组
                        common.get(""BMaterialGroup"", ""GetGroupCodeName"", ""words="" + Com");
                ...
                if (opts.param.table == ""Organization"") {
                    ...
                    common.get(""SOrganization"", ""GetOrganizationCodeName"", ""words="" + CommonBUI.UrlEncode(opts.text), function (rdata) {
                        if (rdata.result.length == 1) {
                            ...
                            var target = opts.target;
                            target.setSea");
            WriteLiteral(@"rchValue(data.ID || 0);
                            target.setSearchText(data.OrgName || """");
                        } else {
                            //查询物料组
    ...
    common.searchLocation = function () {
        ...
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                ...
                var addItems = ""add="" + BUI.JSON.stringify(locationIds");
            WriteLiteral(@") + ""&groupId="" + deleteRow.id;
