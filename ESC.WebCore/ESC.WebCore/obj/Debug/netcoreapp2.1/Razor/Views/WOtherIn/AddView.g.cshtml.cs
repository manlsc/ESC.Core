#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WOtherIn\AddView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "972ecc9f259be5ddaa4617cd1cfc130b4ac65840"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"972ecc9f259be5ddaa4617cd1cfc130b4ac65840", @"/Views/WOtherIn/AddView.cshtml")]
...
<script type=""text/javascript"">
    ...
    function initGrid(iData) {
        ...
        bGrid.fSearch = function (opts) {
            if (BUI.isNullOrEmpty(opts.text) || opts.evttype == ""click"") { 
                ...
                ");
            WriteLiteral(@"if (opts.param.table == ""BLocation"") {
                    //查询存储单元
    ...
    function searchBp(frm, opts) {
        var dialog = new BUI.Overlay.Dialog({
            ...
            success: function () {
                var data = CommonBUI.ExcuteIFrameMethod(""ifrmS");
            WriteLiteral(@"earch"", ""getData"");
                if (data) {
