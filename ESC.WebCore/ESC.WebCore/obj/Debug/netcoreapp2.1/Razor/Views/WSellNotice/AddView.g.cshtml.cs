#pragma checksum "E:\demo\ESC.Core\ESC.WebCore\ESC.WebCore\Views\WSellNotice\AddView.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8cb04b7514a9098b84c453a96b0c59532df1a7a2"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8cb04b7514a9098b84c453a96b0c59532df1a7a2", @"/Views/WSellNotice/AddView.cshtml")]
...
");
      ...
      ");
        ...
        function initColumns(iData) {
            for (var i = 0; i < iData.Columns.length; i++) {
                s");
                WriteLiteral(@"witch (iData.Columns[i].dataIndex) {
                    case ""CreateDate"":
                    case ""CreateBy"":
                    case ""UpdateDate"":
                    case ""UpdateBy"":
 ...
 ");
            ...
            $(""#bt");
                WriteLiteral("nCancel\").click(function () {\r\n                window.location.href = \"../WSellNotice/Index\";\r\n            });\r\n        });\r\n\r\n    </script>\r\n    ");
                EndContext();
            }
            );
