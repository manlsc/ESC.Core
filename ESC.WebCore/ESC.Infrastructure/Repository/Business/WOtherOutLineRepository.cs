...
namespace ESC.Infrastructure.Repository
{
    ...
    public class WOtherOutLineRepository : BaseRepository<WOtherOutLine>
    {
        ...
        public WOtherOutLineRepository() : base(){}

        public WOtherOutLineRepository(string connectionString) : base(connectionString){}

        public WOtherOutLineRepository(DatabaseContext dbContext) : base(dbContext){}
        ...
        public string GetSearchSql()
        {
            string searchSql = @"SELECT SI.* ,
                                ...
                                FROM    WOtherOutLine SI WITH ( NOLOCK )
        ...
        {
            string sql = "DELETE FROM WOtherOutLine WHERE ParentID=" + parentId;
            return Execute(sql);
        }
        ...
        /// <param name="parentId"></param>
        /// <returns></returns>
        public List<WOtherOutLine> GetLinesByParentId(int parentId)
        {
            string sql = "SELECT * FROM WOtherOutLine WITH(NOLOCK) WHERE ParentID=" + parentId;
            return Query(sql);
        }
