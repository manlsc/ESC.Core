...
namespace ESC.Infrastructure.Repository
{
    public class WPurchaseReturnLineRepository : BaseRepository<WPurchaseReturnLine>
    {
        ...
        public WPurchaseReturnLineRepository() : base() { }

        public WPurchaseReturnLineRepository(string connectionString) : base(connectionString) { }

        public WPurchaseReturnLineRepository(DatabaseContext dbContext) : base(dbContext) { }
        ...
        public string GetSearchSql()
        {
            string searchSql = @"SELECT  T1.* ,
                                    ...
                                    FROM    WPurchaseReturnLine T1 WITH ( NOLOCK )
        ...
        /// <returns></returns>
        public List<WPurchaseReturnLine> GetLinesByParentId(int parentId)
        {
        ...
        {
            string sql = "DELETE FROM WPurchaseReturnLine WHERE ParentID=" + parentId;
            return Execute(sql);
        }
    }
}
