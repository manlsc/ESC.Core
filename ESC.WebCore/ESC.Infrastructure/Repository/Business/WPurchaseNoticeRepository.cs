...
namespace ESC.Infrastructure.Repository
{
    public class WPurchaseNoticeRepository : BaseRepository<WPurchaseNotice>
    {
        ...
        public WPurchaseNoticeRepository() : base(){}

        public WPurchaseNoticeRepository(string connectionString) : base(connectionString){}

        public WPurchaseNoticeRepository(DatabaseContext dbContext) : base(dbContext){}
        ...
        public string GetSearchSql()
        {
             string searchSql = @"SELECT  T1.* ,
                                ...
                                FROM    WPurchaseNotice T1 WITH ( NOLOCK )
        ...
        {
            string sql = "UPDATE WPurchaseNotice SET NoticeStatus = " + noticeStatus + ",UpdateDate = GETDATE() WHERE ID = " + Id;
            Execute(sql);
        }
        ...
        {
            string sql = "DELETE FROM WPurchaseNotice WHERE ID=" + noticeId + " AND NoticeStatus=" + stockStatus;
            return Execute(sql);
        }
    }
}
