...
{
    public class WTransferInNoticeLine : PocoObject
    {

        public WTransferInNoticeLine()
        {
        ...
        /// 入库数量
        /// </summary>
        [Column("InCount", "通知数量", true, true, true, 160, "")]
        ...
        /// 入库数量
        /// </summary>
        [Column("InPutCount", "入库数量", true, true, false, 160, "")]
        ...
        [Column("StockID", "StockID", false, true, true, 160, "")]
