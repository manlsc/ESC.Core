...
{
    public class WSellNotice : PocoObject
    {

        public WSellNotice()
        {
            Lines = new List<WSellNoticeLine>();
        ...
        /// 通知单号
        /// </summary>
        [Column("OutNoticeCode", "通知单号", true, true, true, 160, "")]
        public string OutNoticeCode { get; set; }

        /// <summary>
        /// 来源单号
        /// </summary>
        [Column("SourceCode", "来源单号", false, true, true, 160, "")]
        ...
        [Ignore]
        public List<WSellNoticeLine> Lines { set; get; }
    }
}
