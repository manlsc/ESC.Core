...
namespace ESC.Infrastructure.DomainObjects
{
    ...
    /// 其他出库
    /// </summary>
    public class WOtherOutLine : PocoObject
    {

        public WOtherOutLine()
        {
        ...
        /// 货位
        /// </summary>
        [Column("PositionID","货位",true,true, true, 160, "PositionName")]
        ...
        /// 物料
        /// </summary>
        [Column("MaterialID","物料",true,true, true, 160, "MaterialName")]
        ...
        /// 批次
        /// </summary>
        [Column("Batch","批次",true,false, true, 160,"")]
        ...
        /// 更新时间
        /// </summary>
        [Column("UpdateDate","更新时间", false, true,true,160,"")]
        public DateTime UpdateDate { get; set; }

        /// <summary>
        /// 更新人
        /// </summary>
        [Column("UpdateBy","更新人",false,true,true,160, "UpdateByUserName")]
        ...
        /// 入库时间
        /// </summary>
        [Column("StockInDate", "入库时间", false, true, false, 160, "")]
