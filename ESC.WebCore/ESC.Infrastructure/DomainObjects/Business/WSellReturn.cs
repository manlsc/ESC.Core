...
{
    public class WSellReturn : PocoObject
    {
        public WSellReturn()
        {
            Lines = new List<WSellReturnLine>();
        ...
        /// 销售退库单号
        /// </summary>
        [Column("SellReturnCode", "退库单号", true, true, true, 160, "")]
        public string SellReturnCode { get; set; }
        ...
        [Ignore]
        public List<WSellReturnLine> Lines { set; get; }
