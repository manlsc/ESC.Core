...
{
    public class WSellLine : PocoObject
    {
        public WSellLine()
        {
        ...
        /// 临时出库数量
        /// </summary>
        [Column("OutPutCount", "临时出库数量", false, true, false, 160, "")]
        public decimal OutPutCount { set; get; }

        /// <summary>
        /// 退库数量
        /// </summary>
        [Column("ReturnCount", "退库数量", false, true, false, 160, "")]
        public decimal ReturnCount { set; get; }
