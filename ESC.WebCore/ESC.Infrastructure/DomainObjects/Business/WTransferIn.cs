...
{
    public class WTransferIn : PocoObject
    {
        public WTransferIn()
        {
            CreateDate = new DateTime(1900, 1, 1);
            UpdateDate = new DateTime(1900, 1, 1);
            Lines = new List<WTransferInLine>();
        }

        /// <summary>
        /// 入库单号
        /// </summary>
        [Column("TransferInCode", "入库单号", true, true, true, 160, "")]
        ...
        [Ignore]
        public List<WTransferInLine> Lines { set; get; }
    }
}
