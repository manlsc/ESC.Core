...
namespace ESC.Infrastructure.DomainObjects
{
    ...
    /// 库存
    /// </summary>
    public class WStock : PocoObject
    {
        public WStock()
        {
        ...
        /// 占用数量
        /// </summary>
        [Column("TakeCount", "占用数量", true, true, true, 160, "")]
        public decimal TakeCount { get; set; }

        /// <summary>
        /// 冻结数量
        /// </summary>
        [Column("FrozenCount", "冻结数量", true, true, true, 160, "")]
        public decimal FrozenCount { get; set; }

        /// <summary>
        /// 在途数量
        /// </summary>
        [Column("TransitCount", "在途数量", true, true, true, 160, "")]
        ...
        /// 入库时间
        /// </summary>
        [Column("StockInDate", "入库时间", true, true, true, 160, "")]
